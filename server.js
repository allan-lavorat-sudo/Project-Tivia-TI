...
// Caminho atualizado para o arquivo ambiente.js
const { formaDeExecucao, urlDocumentacao, aplicacaoExecutandoLocalmente } = require('./ServeRest-trunk/src/utils/ambiente')
const { conf } = require('./ServeRest-trunk/src/utils/conf')
const getRandomFinancialContributor = require('./ServeRest-trunk/src/utils/getRandomFinancialContributor')
...
// Caminho atualizado para app.js
const app = require('./ServeRest-trunk/src/app')
